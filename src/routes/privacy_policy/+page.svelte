<section id="Summary" class="py-30 tablet:w-full py-20 bg-[#181818] text-white">
...
<section id="Use_of_personal_data" class="w-full py-20 bg-[#181818] text-white">
	<div class="w-[90%] mx-auto text-center laptop:text-justify max-w-7xl">
		...
		<p class="text-xs tablet: text-gray-300 text-xl md:text-xl leading-relaxed space-y mt-4">
