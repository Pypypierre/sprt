<section id="who_we_are" class="w-full py-20 bg-black text-white">
	<div class="w-[90%] mx-auto max-w-7xl text-center">
	    ...
	    <p class="text-justify md:!text-center text-lg md:text-xl text-gray-300 mb-12 leading-relaxed">
		...
		<div class="grid grid-cols-2 gap-6 md:gap-12 items-stretch text-justify">
		...
		<div class="grid grid-cols-2 gap-6 md:gap-12 items-stretch text-justify">
			<div class="flex flex-col items-center text-center h-full justify-center">
				<p class="text-gray-400 max-w-xs text-sm leading-relaxed text-justify">
